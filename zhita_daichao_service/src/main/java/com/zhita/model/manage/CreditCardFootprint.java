...
//完全复制CommodityFootprint实体类
//信用卡足迹表
public class CreditCardFootprint {
    ...
    public CreditCardFootprint(Integer id, Integer userid, String footprint, String footprinttime, String deleted, String company) {
        this.id = id;
        this.userid = userid;
