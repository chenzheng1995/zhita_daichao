...
public interface ExpenditureBillMapper {
    ...
    List<ExpenditureBill> queryAllByTimeLike(Integer userid,String time, String company);
    
    //通过时间准确查询出当前用户  当前月 每一天  的支出详细信息
    List<ExpenditureBill> queryAllByTime(Integer userid,String time, String company);
